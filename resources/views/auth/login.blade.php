...
<body>
    <section class="h-[100vh] flex lg:flex-row">
        ...
        <div class="w-full lg:w-1/2 flex flex-col justify-center items-center py-10 gap-10">
            <h1 class="md:mb-4 text-2xl font-semibold tracking-wide text-slate-700 md:text-4xl">Login</h1>
            <form action="{{ route('login') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="flex flex-col justify-center items-center">
                    ...
                    <button
                        class="w-full h-10 mt-5 rounded-md bg-primary text-slate-50 hover:bg-green-800">Masuk</button>

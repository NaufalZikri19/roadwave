...
<body>
    <section class="h-[100vh] flex lg:flex-row">
        <div class="hidden w-full lg:w-1/2 lg:flex flex-col justify-center items-center px-16 py-16 bg-primary">
            <img class="sm:w-[60%] lg:w-[80%]" src="{{ asset('assets/icon/logo-white.png') }}"
                    alt="Online illustrations by Storyset">
        </div>
        <div class="w-full lg:w-1/2 flex flex-col justify-center items-center py-10 gap-10">
            <h1 class="md:mb-4 text-2xl font-semibold tracking-wide text-slate-700 md:text-4xl">Registrasi</h1>
            <form action="{{ route('register') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="flex flex-col justify-center items-center">
                    ...
                    <button
                        class="w-full h-10 mt-5 rounded-md bg-primary text-slate-50 hover:bg-green-800">Daftar</button>
                </div>
            </form>
        </div>
    </section>

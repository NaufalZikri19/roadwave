...
<nav class="flex mt-24 ps-7 mb-7 max-w-screen-xl mx-auto" aria-label="Breadcrumb">
    <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
      ...
      <li aria-current="page">
        <div class="flex items-center">
          ...
          <span class="ms-1 text-sm font-medium text-gray-500 md:ms-2">Kebijakan Hak Cipta</span>
        </div>
      </li>
    </ol>
  </nav>
  ...
  <div class="mt-10 mb-10">
    ...
    <ul class="flex flex-wrap text-sm font-medium text-center text-gray-500 border-b border-gray-200 mt-5 px-7 md:px-10">
      ...
      <li class="me-2">
        <a href="/kebijakanhakcipta" aria-current="page" class="inline-block p-4 text-white bg-mainColor rounded-t-lg active">Kebijakan Hak Cipta</a>
      </li>
      <li class="me-2">
    ...
    <div class="px-10 md:px-14 py-5 mb-5">
      <h3 class="text-3xl font-semibold text-slate-700 mb-5 mt-5">Copyright</h3>

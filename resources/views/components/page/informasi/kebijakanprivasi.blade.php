 ...
 <nav class="flex mt-24 ps-7 mb-7 max-w-screen-xl mx-auto" aria-label="Breadcrumb">
    <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
      ...
      <li aria-current="page">
        <div class="flex items-center">
          ...
          <span class="ms-1 text-sm font-medium text-gray-500 md:ms-2">Kebijakan Privasi</span>
        </div>
      </li>
    </ol>
  </nav>
  ...
  <div class="mt-10 mb-10">
    ...
    <ul class="flex flex-wrap text-sm font-medium text-center text-gray-500 border-b border-gray-200 mt-5 px-7 md:px-10">
      ...
      <li class="me-2">
        <a href="/kebijakanprivasi" aria-current="page" class="inline-block p-4 text-white bg-mainColor rounded-t-lg active">Kebijakan Privasi</a>
      </li>
      <li class="me-2">
        <a href="/kebijakanhakcipta" class="inline-block p-4 rounded-t-lg hover:text-gray-600 hover:bg-gray-50">Kebijakan Hak Cipta</a>
      </li>
      <li class="me-2">
        <a href="/syaratketentuan" class="inline-block p-4 rounded-t-lg hover:text-gray-600 hover:bg-gray-50">Syarat & Ketentuan Berlaku</a>
      </li>
      <li class="me-2">
    ...
    <div class="px-10 md:px-14 py-5 mb-5">
      <h3 class="text-3xl font-semibold text-slate-700 mb-10 mt-5">Kebijakan Privasi</h3>
      <ol class="space-y-10 text-gray-700 list-decimal list-inside text-xl font-semibold mb-2">
        <li>
          Pendahuluan
          ...
          <p class="text-base font-normal my-4 text-gray-500 px-1 text-justify">Untuk tujuan pemahaman Kebijakan Perlindungan Data Pribadi roadwaveapparel.com, kebijakan ini memiliki arti sebagai berikut :</p>
          <p class="text-base font-normal my-4 text-gray-500 px-1 text-justify">
            <span class="font-bold text-gray-700">“Hukum yang Berlaku”</span> berarti seluruh peraturan dan perundang-undangan yang terkait dengan perlindungan dan/atau pengelolaan data pribadi yang berlaku di
          ...
          <p class="text-base font-normal my-4 text-gray-500 px-1 text-justify">
            <span class="font-bold text-gray-700">“Data Pribadi”</span> berarti data apapun mengenai (a) seorang individu yang dapat diidentifikasi (i) dari data tersebut; atau (ii) dari data dan informasi lain yang
          ...
          <p class="text-base font-normal my-4 text-gray-500 px-1 text-justify">
            <span class="font-bold text-gray-700">“Media Sosial”</span> berarti halaman dan akun Roadwave Apparel dalam platform media sosial milik pihak ketiga seperti Instagram, Shopee, dan Tiktok.
          </p>
          <p class="text-base font-normal my-4 text-gray-500 px-1 text-justify">
            <span class="font-bold text-gray-700">“Website”</span> berarti website 3Second yang dapat diakses melalui alamat www.roadwaveapparel.com;
          </p>
          <p class="text-base font-normal my-4 text-gray-500 px-1 text-justify">
        ...
        <li>
          ...
          <p class="text-base font-normal my-4 text-gray-500 px-1 text-justify">Kami akan/mungkin mengumpulkan data pribadi Anda saat :</p>
        ...
        <li>
          ...
          <p class="text-base font-normal my-4 text-gray-500 px-1 text-justify">Terkait dengan penggunaan data pribadi, kami mungkin akan mengungkapkan data pribadi Anda kepada:</p>
          <ul class="ps-10 space-y-1 list-disc list-outside text-base text-gray-500 font-normal">
            <li>Pegawai kami.</li>
        ...
        <li>
          Hukum yang Berlaku
          <p class="text-base font-normal my-4 text-gray-500 px-1 text-justify">Kebijakan ini dan penggunaan Website diatur menurut hukum yang berlaku di Republik Indonesia.</p>
        </li>
        <li>

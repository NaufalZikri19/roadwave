 ...
 <nav class="flex mt-24 ps-7 mb-7 max-w-screen-xl mx-auto" aria-label="Breadcrumb">
    <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
      ...
      <li aria-current="page">
        <div class="flex items-center">
          ...
          <span class="ms-1 text-sm font-medium text-gray-500 md:ms-2">Aturan Pengguna</span>
        </div>
      </li>
    </ol>
  </nav>
  ...
  <div class="mt-10 mb-10">
    ...
    <ul class="flex flex-wrap text-sm font-medium text-center text-gray-500 border-b border-gray-200 mt-5 px-7 md:px-10">
      ...
      <li class="me-2">
        <a href="/aturanpenggunaan" aria-current="page" class="inline-block p-4 text-white bg-mainColor rounded-t-lg active">Aturan Pengguna</a>
      </li>
      <li class="me-2">
        <a href="/kebijakanprivasi" class="inline-block p-4 rounded-t-lg hover:text-gray-600 hover:bg-gray-50">Kebijakan Privasi</a>
      </li>
      <li class="me-2">
        <a href="/kebjakanhakcipta" class="inline-block p-4 rounded-t-lg hover:text-gray-600 hover:bg-gray-50">Kebijakan Hak Cipta</a>
      </li>
      <li class="me-2">
    ...
    <div class="px-10 md:px-14 py-5 mb-5">
      <h3 class="text-3xl font-semibold text-slate-700 mb-10 mt-5">Aturan Pengguna</h3>
      <h4 class="text-xl font-semibold text-slate-700 mb-2">Pendahuluan</h4>
      ...
      <p class="mb-7 text-gray-500 px-1 text-justify">
      ...
      <h4 class="text-xl font-semibold text-slate-700 mb-2">Data Pengguna</h4>
      <ol class="list-decimal list-inside">
        <li class="text-gray-500 px-1 text-justify mb-3">

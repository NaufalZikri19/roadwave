...
<nav class="flex mt-24 ps-7 mb-7 max-w-screen-xl mx-auto" aria-label="Breadcrumb">
  ...
  <div class="mt-10 mb-10 w-full max-w-screen-xl mx-auto">
    ...
    <ul class="flex flex-wrap text-sm font-medium text-center text-gray-500 border-b border-gray-200 mt-5 px-7 md:px-10">
      <li class="me-2">
        <a href="/tentangkami" aria-current="page" class="inline-block p-4 text-white bg-mainColor rounded-t-lg active">Tentang Kami</a>
      </li>
      <li class="me-2">
    ...
    <div class="px-10 md:px-14 py-5 mb-5">
      <h3 class="text-3xl font-semibold text-slate-700 mb-5 mt-5">Tentang Roadwave</h3>
      ...
      <p class="text-gray-500 px-1 text-justify">

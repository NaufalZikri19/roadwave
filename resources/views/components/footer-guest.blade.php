...
<footer class="bg-white mb-16 sm:mb-0 mt-28">
    <div class="mx-auto w-full max-w-screen-xl">
        <div class="flex flex-wrap justify-around gap-[8px] md:px-8 md:justify-between">
            <div class="w-[150px] flex-2">
                ...
                <ul class="text-gray-500 font-medium">
                    <li class="mb-4">
                        <a href="" class="hover:underline text-sm">T-Shirt</a>
                    </li>
                    <li class="mb-4">
                        <a href="" class="hover:underline text-sm">Shirt</a>
                    </li>
                    <li class="mb-4">
                        <a href="" class="hover:underline text-sm">Pants</a>
                    </li>
                    <li class="mb-4">
                        <a href="" class="hover:underline text-sm">Outwear</a>
                    </li>
                </ul>
            </div>
            <div class="w-[150px] flex-2">
        ...
        <div class="hidden px-4 py-6 md:flex md:items-center md:justify-between">
            <span class="text-sm text-gray-500 sm:text-center">© 2023 <a
                    href="#">Roadwave™</a>. All Rights Reserved. </span>
